...
<body>
	...
	<div class="container">
		<div class="jumbotron">
			...
			<p>Ajouter, modifier vos annonces ou faite une recherche pour trouver ce que vous voulez !!</p>
			<p>
				<a class="btn btn-lg btn-primary" href="ajoutAnnonce" role="button">Ajouter une annonce !! Vite !!!</a>
			</p>
		</div>
	</div> 
</body>
